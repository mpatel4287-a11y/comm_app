...
class LanguageService extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'events': 'Events',
      'home': 'Home',
      'offline_mode': 'Offline Mode - Limited data',
      'analytics': 'Analytics',
      ...
      'organizational_roles': 'Organizational Roles',
      'assign_member': 'Assign Member',
      'assigned_members': 'Assigned Members',
      'members_assigned': 'Members Assigned:',
      'no_roles_defined': 'No roles defined for ',
      'no_members_assigned': 'No members assigned yet.',
      'add_role_to': 'Add Role to ',
      'edit_role_title': 'Edit Role Title',
      'confirm_delete_role': 'Are you sure you want to delete this role?',
      'remove_from_role': 'Remove from role',
      'role_title_hint': 'Role Title (e.g. President, Secretary)',
      'member_already_assigned': 'This member is already assigned to this role.',
      'manage_roles_subtitle': 'Manage Samaj & Mandal roles',
      'view_firms_subtitle': 'View all firms and members',
      'committees_roles': 'Committees & Roles',
      'coming_soon_for': 'Coming soon for',
    ...
    'gu': {
      ...
      'events': 'કાર્યક્રમો',
      'home': 'હોમ',
      'offline_mode': 'ઓફલાઇન મોડ - મર્યાદિત માહિતી',
      ...
      'demote_member': 'મેનેજર તરીકે ડિમોટ કરવા',
      'promote_member': 'મેનેજર તરીકે બઢતી આપવા',
      'are_you_sure_role': 'શું તમે ખરેખર',
      'demote': 'ડિમોટ કરવા',
      'promote': 'બઢતી આપવા',
      'demoted_success': 'મેનેજરને સભ્ય તરીકે ડિમોટ કરવામાં આવ્યા છે!',
      'promoted_success': 'સભ્યને મેનેજર તરીકે બઢતી આપવામાં આવી છે!',
      ...
      'wife_of': 'ના પત્ની',
      'husband_of': 'ના પતિ',
      'select_spouse': 'જીવનસાથી પસંદ કરો',
      ...
      'male': 'શ્રી (પુરૂષ)',
      'female': 'શ્રીમતી (સ્ત્રી)',
      'view_ancestry': 'વંશાવલી જુઓ',
      'member_spotlight': 'સભ્ય સ્પોટલાઇટ',
      'organizational_roles': 'સંગઠનાત્મક હોદ્દા',
      'assign_member': 'સભ્ય નિમણૂક',
      'assigned_members': 'નિયુક્ત સભ્યો',
      'members_assigned': 'નિયુક્ત સભ્યો:',
      'no_roles_defined': 'આ કેટેગરી માટે કોઈ હોદ્દો નક્કી કરેલ નથી ',
      'no_members_assigned': 'હજુ સુધી કોઈ સભ્યો નિમણૂક કરવામાં આવ્યા નથી.',
      'add_role_to': 'માં હોદ્દો ઉમેરો: ',
      'edit_role_title': 'હોદ્દાનું શીર્ષક સંપાદિત કરો',
      'confirm_delete_role': 'શું તમે ખરેખર આ હોદ્દો કાઢી નાખવા માંગો છો?',
      'remove_from_role': 'હોદ્દા પરથી દૂર કરો',
      'role_title_hint': 'હોદ્દાનું શીર્ષક (દા.ત. પ્રમુખ, મંત્રી)',
      'member_already_assigned': 'આ સભ્ય પહેલેથી જ આ હોદ્દા પર છે.',
      'manage_roles_subtitle': 'સમાજ અને મંડળના હોદ્દાઓ મેનેજ કરો',
      'view_firms_subtitle': 'બધી પેઢીઓ અને સભ્યો જુઓ',
      'committees_roles': 'સમિતિઓ અને હોદ્દાઓ',
      'coming_soon_for': 'માટે ટૂંક સમયમાં આવી રહ્યું છે',
      'to_be_announced': 'જાહેરાત કરવામાં આવશે',
      'samaj': 'સમાજ',
